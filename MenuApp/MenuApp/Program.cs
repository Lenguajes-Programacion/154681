using System;
using MenuApp.PracticaDos;
using MenuApp.PracticaUno;
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while (!close_calculator)
            {
                ...
                Console.WriteLine("Elige que proyecto deseas ver:");
                Console.WriteLine("(1) Comprobacion de usuario");
                Console.WriteLine("(2) Calculadora");
                string opcion = Console.ReadLine();
                switch (opcion)
                {
                    case "1":
                        HolaMundo.Comprobacion();
                        break;
                    case "2":
                        Calculadora.Calc();
                        break;
